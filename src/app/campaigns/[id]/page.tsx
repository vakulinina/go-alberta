  ...
  return (
    <div className="px-[120px] py-[80px] max-xl:px-[60px]">
      ...
      <div className="flex h-[3000px] flex-row gap-[100px] max-xl:gap-[50px] max-lg:flex-col-reverse max-lg:justify-end">
        <div>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga est delectus veritatis esse. Libero facere odit
          nesciunt doloribus saepe quos temporibus dolorem, laborum veritatis quod in consectetur nam quidem
